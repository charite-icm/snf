...
def test_get_n_clusters_with_explicit_value():
...
def test_get_n_clusters_with_nb_clusters_fallback():
...
def test_get_n_clusters_invalid_n_clusters():
...
def test_get_n_clusters_invalid_nb_clusters():
...
def test_get_n_clusters_edge_cases():
